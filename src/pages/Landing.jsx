    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-hero-gradient">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center pt-24 pb-32">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium px-4 py-2 rounded-full mb-8 animate-fade-in">
          ...
          Direktori Bisnis Lokal #1 di Banyumas
        </div>
        ...
        <p className="text-lg sm:text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed animate-slide-up">
          Temukan bisnis lokal terbaik di Banyumas — dari kuliner, otomotif, hingga jasa profesional. Semua ada di Goleet.id.
        </p>
    ...
    <section className="py-16 bg-surface-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="section-title">Temukan Berdasarkan Kategori</h2>
          <p className="section-subtitle">Jelajahi ribuan bisnis lokal di berbagai bidang</p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
          {categories.map((cat) => (
            <button
              ...
              className="group flex flex-col items-center gap-3 p-4 rounded-2xl bg-white hover:bg-primary-600 border border-surface-100 hover:border-primary-600 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              <span className="text-2xl group-hover:scale-110 transition-transform duration-300">{cat.icon}</span>
              <span className="text-xs font-semibold text-slate-600 group-hover:text-white transition-colors text-center leading-tight">{cat.label}</span>
            </button>
          ))}
        </div>
      </div>
    ...
    <section className="py-20 bg-hero-gradient relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center px-4">
        ...
        <p className="text-blue-100 mb-8 text-lg">
          Jangkau ribuan calon pelanggan digital di Banyumas. Mulai gratis 30 hari.
        </p>
