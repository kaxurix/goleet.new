...
export default function Auth() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:block bg-hero-gradient">
        {/* Decorative blobs */}
        <div className="absolute top-0 right-0 rounded-full w-72 h-72 bg-white/5 blur-3xl" />
        <div className="absolute bottom-0 left-0 rounded-full w-72 h-72 bg-indigo-500/20 blur-3xl" />
        <div className="absolute w-48 h-48 rounded-full top-1/2 left-1/4 bg-blue-400/10 blur-3xl" />
        ...
        <div className="absolute inset-0 flex flex-col p-12">
          ...
          <div className="flex flex-col justify-center flex-1">
            <div className="flex items-center justify-center mb-8 border w-14 h-14 rounded-3xl bg-white/10 backdrop-blur-sm border-white/20">
              <Sparkles className="w-8 h-8 text-amber-300" />
            </div>
            <h2 className="mb-4 text-4xl font-black leading-tight text-white">
              Platform Bisnis Lokal
              <br />
            ...
            <p className="mb-10 text-base leading-relaxed text-blue-100">
              Bergabunglah dengan ribuan pemilik bisnis yang sudah mengembangkan
              usaha mereka bersama Goleet.id.
            </p>
            <ul className="space-y-4">
              {features.map(({ icon: Icon, text }) => (
                <li key={text} className="flex items-center gap-3">
                  <div className="flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-xl bg-white/10">
          ...
          <div className="flex-shrink-0">
            <p className="text-xs text-white/30">
              © 2026 Goleet.id — All rights reserved.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* ── Right Panel ── */}
      <div className="flex items-start justify-center flex-1 px-6 pt-16 pb-12 overflow-y-auto sm:px-12 bg-surface-50">
        <div className="w-full max-w-md">
          ...
          {/* Tab switcher */}
          <div className="flex gap-1 p-1 mb-8 bg-surface-200 rounded-2xl">
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              {tab === "login"
                ...
                : "Daftar gratis, mulai dalam 2 menit"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {tab === "register" && (
              <div>
                <label className="label-base" htmlFor="auth-name">
                  Nama Lengkap
                </label>
            ...
            {tab === "register" && (
              <div>
                <label className="label-base" htmlFor="auth-role">
                  Daftar sebagai
                </label>
                <select
                  id="auth-role"
